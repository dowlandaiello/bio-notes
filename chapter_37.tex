...
through the construction of complex organic molecules based on incoming \ch{CO2}.
Consumers then pass carbon throughout the community by way of predation, and return
\ch{CO2} to the environment---as do producers---through respiration. Carbon left
...
capable of processing \ch{N2} itself, and must consume this chemical through
an intermediary bacterium which provides the act of \textbf{nitrogen fixation}---
the conversion of \ch{N2} into a usable source of nitrogen, usually consisting of
two parts (\ch{NH4+} and \ch{NO3-}). Of the two kinds of nitrogen nitrified by
nitrogen-fixating bacteria, nitrate (\ch{NO3-}) is the most commonly and efficiently
