...
\chem{CO2} to the environment---as do producers---through respiration. Carbon left
...
capable of processing \chem{N2} itself, and must consume this chemical through
an intermediary bacterium which provides the act of \textbf{nitrogen fixation}---
the conversion of \chem{N2} into a usable source of nitrogen, usually consisting of
two parts (\chem{NH4+} and \chem{NO3-}). Of the two kinds of nitrogen nitrified by
nitrogen-fixating bacteria, nitrate (\chem{NO3-}) is the most commonly and efficiently
